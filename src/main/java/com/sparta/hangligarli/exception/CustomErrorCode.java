...
public enum CustomErrorCode {
    ...
    DUPLICATE_USER(BAD_REQUEST, "중복된 사용자가 존재합니다=======배포 테스트"),
    DUPLICATE_NICKNAME(BAD_REQUEST, "중복된 닉네임이 존재합니다=======배포 테스트"),
    NOT_PROPER_PASSWORD(BAD_REQUEST, "비밀번호가 일치하지 않습니다.=======배포 테스트"),
